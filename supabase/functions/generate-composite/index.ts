...
请执行一项高难度的“人物替换与虚拟合影生成”任务。你需要将上传的**用户自拍形象图**融入到**目标背景图**中，
并生成用户与**币安创始人 CZ (Changpeng Zhao)** 并排合影的画面。
...
1.  **场景重构、去人与品牌保护：**
    ...
    * **品牌元素锁定（关键）：** 识别并严格保留背景墙/展板上的品牌关键词（**Binance, Yzi Labs, BNB Chain, Aster** 等）。
    确保这些 Logo 和文字清晰、不扭曲。如果在修复背景时涉及这些区域，请根据上下文逻辑补全文字，不要使其模糊。
