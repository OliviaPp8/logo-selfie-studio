    ...
    <section className="pt-32 pb-16 px-4">
      <div className="container mx-auto text-center max-w-3xl">
        ...
        <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-slide-up animation-delay-100">
          Take a Photo with
          <span className="text-gradient block mt-2">Big Tech Logos</span>
        </h1>
        
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto animate-slide-up animation-delay-200">
          Upload your full-body photo and pose next to iconic company logos. 
          Perfect for social media, memes, or just for fun!
        </p>
      </div>
    </section>
  );
